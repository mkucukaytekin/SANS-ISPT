...
The \gls{infosec} team will verify compliance to this policy through various methods, including but not limited to, periodic walk-thr\ins{o}u\ins{ghs}, video monitoring, business tool reports, internal and external audits, inspections, and provide feedback to the policy owner.
...
\newcommand{\PasswordPolicies}{%
\oldnew{\textit{Password Policy}}{password policies (see \see{G:PCG} and \see{G:PPP})}%
}
